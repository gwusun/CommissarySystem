...
--
-- Host: localhost
-- Generation Time: 2017-08-18 06:35:36
...
(1, 'on', '2015级', '软件工程', '数据库', '实验报告', 1502960546, './data/', '快点交交交', './Uploads/');
...
--
ALTER TABLE `blog_upwork`
  MODIFY `work_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'id';
--
...
--
ALTER TABLE `blog_user`
  MODIFY `user_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'id';COMMIT;
