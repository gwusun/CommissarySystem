...
--
-- Host: localhost
-- Generation Time: 2017-08-20 04:37:57
...
(1, 'off', '2015级', '软件工程', '数据库', '实验报告', 1503195965, './数据库作业/', '快点交交交', './Uploads/');
...
(1, '1228746736@qq.com', '20150107030131', '1', '孙武', '1', 1423432, '1', '', '1', 83, 4, 'svip');
...
--
ALTER TABLE `blog_upwork`
  MODIFY `work_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'id', AUTO_INCREMENT=10;
--
